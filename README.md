...
The goal of this project is to re-implement results from the paper *LoRA: Low-Rank Adaptation of Large Language Models* by Edward Hu, Yelong Shen, Phillip Wallis, Zeyuan Allen-Zhu, Yuanzhi Li, Shean Wang, Lu Wang, and Weizhu Chen. 
...
![Figure 1](assests/Tuning10%AB.png)
